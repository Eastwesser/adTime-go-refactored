...
func RunMigrations(ctx context.Context, db *sql.DB, logger *zap.Logger) error {
	...
	if err := goose.UpContext(ctx, db, "internal/storage/postgres/migrations"); err != nil {
...
func RollbackMigration(ctx context.Context, db *sql.DB, logger *zap.Logger) error {
	...
	if err := goose.DownContext(ctx, db, "internal/storage/postgres/migrations"); err != nil {
...
func Status(ctx context.Context, db *sql.DB, logger *zap.Logger) error {
	...
	if err := goose.StatusContext(ctx, db, "internal/storage/postgres/migrations"); err != nil {
